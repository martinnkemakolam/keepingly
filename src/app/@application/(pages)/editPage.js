...
export default function EditProperty({ id }) {
  ...
  let dbEdit = () => {
    ...
    api
      .patch(`/api/v2/update/property/${id.id}/`, data, {
        headers: {
  ...
  return (
    <>
      ...
      <PropertyInfo
        ...
        newBtn={true}
        showSvg={true}
        h1Text={`${id.address_one},${id.city},${id.state} ${id.zipcode}`}
        buttonText={"Invite homeowner"}
        extraButtonText={disable ? `Edit property` : `Save property`}
        extraButtonFunc={changeButtonOrSubmit}
        buttonFunc={() => null}
      />
      <FormProperties
        disable={disable}
