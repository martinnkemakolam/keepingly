...
export let DocumentPage =()=>{
    ...
    return (
        <div className={style.video}>
            ...
            {console.log(properties[id]?.has_received_invite)}
            ...
            <PropertyInfo h1Text={`${properties[id]?.address_one}, ${properties[id]?.city} ${properties[id]?.zipcode}`} setId={setId} arrProperties={properties} showSvg={true} buttonText={ role.current === 'realtor' ? (properties[id]?.has_received_invite ? null : `Invite homeowner`) : null} buttonFunc={()=> send()} extraButtonText={`Add document`} extraButtonFunc={()=> add()}/>
