...
export let Overview = () => {
  ...
  let downSvg = (
    ...
    >
      <path
        d='M5.14661 6.66669L8.47994 10L11.8133 6.66669'
        stroke='#A61D4A'
  ...
  let sendSvg = (
    ...
    >
      <path
        opacity='0.15'
        d='M13.8133 2.66669L2.47998 7.33335L7.14665 9.33335L9.14665 14L13.8133 2.66669Z'
        fill='#A61D4A'
      />
      <path
        d='M13.8133 2.66669L2.47998 7.33335L7.14665 9.33335L9.14665 14L13.8133 2.66669Z'
  ...
  useEffect(() => {
    (async () => {
      ...
      Array.isArray(apiValue.data) &&
      apiValue.data[0]?.agency_address !== undefined
        ? ""
        : router.push("/Setting/completeProfile");
      setName(Array.isArray(apiValue.data) ? apiValue.data[0]?.first_name : "");
      sessionStorage.setItem(
        "kppk",
        Array.isArray(apiValue.data) ? apiValue.data[0].id : ""
      );
    })();
  }, [router, name]);
  return (
    <>
      <TopBar
        ...
        svg1={downSvg}
        svg2={sendSvg}
        buttonText1={`Quick actions`}
        buttonText2={`Send appraisal document`}
        showSearch={true}
      />
      {/* for realtor remove this button */}
      <ExpenseTitle
        title={`Accept closing documents`}
        btnStyle1={`redFillBtn`}
        underTitle={`Realtor, James Chimdindu provided your closing documents. Please accept them to claim your property.`}
        buttonText1={`Accept closing documents`}
      />
      <Statistics />
