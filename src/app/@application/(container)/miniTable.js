...
export let MiniTable=({title, btnText, data, btnFunc})=>{
    ...
    return(
        <div className={style.miniTableHolder}>
            <ExpenseTitle title={title} showCount={data.length} btnFunc1={btnFunc} buttonText1={btnText} btnStyle1={`clearBtn`} svg1={arrowLeft}/>
