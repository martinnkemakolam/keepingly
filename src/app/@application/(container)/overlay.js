...
export default function Overlay({overlay, propId,select, currentPage, closeFunc, type}){
    return(
        <div className={style.overlay}>
                {overlay === 'Send' && <SendModal propId={propId} select={select} closeFunc={closeFunc} currentPage={currentPage}/>}
