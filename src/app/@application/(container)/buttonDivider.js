...
export let ButtonDivider=({svg1, buttonText1, svg2, buttonText2, dividerPos, btnFunc1, btnStyle1, btnStyle2,btnFunc2})=>{
    return (
        <div className={`${style.divider} ${dividerPos ? style.left : ''}`}>
                { buttonText1 && <ClearBtn  text={buttonText1} svg={svg1} btnFunc={btnFunc1} btnStyle={btnStyle1}/>}
                ...
                <ClearBtn btnStyle={btnStyle2} text={buttonText2} svg={svg2} btnFunc={btnFunc2}/> </>}
            </div>
    )
}