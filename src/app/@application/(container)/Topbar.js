...
import {SearchInput} from "@/app/@application/(presentation)/search"
import style from '../../../style/properties.module.css'
import { ButtonDivider } from './buttonDivider'
export default function TopBar({title, btnStyle1, btnStyle2, buttonText1, btnFunc2, btnFunc1, svg1, svg2, showSearch, buttonText2}) {
    return(
        <>
        <header className={style.header}>
            <div className={style.headerdiv}>
                <h1 className={style.width100}>{title}</h1>
                {
                    buttonText1 && <>
                    <svg className={style.mobile} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.66675 8L13.3334 8" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <ButtonDivider buttonText1={buttonText1} btnFunc1={btnFunc1} btnFunc2={btnFunc2} btnStyle1={btnStyle1} btnStyle2={btnStyle2} svg1={svg1} svg2={svg2} dividerPos={true} buttonText2={buttonText2}/>
                    </>
                }
            </div>
            {
                showSearch && 
            <div className={style.headerdiv + ' ' +style.mobile} style={{marginLeft: 'auto'}}>
            <SearchInput/>
                <div>
                ...
                <div>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.15" d="M13.3332 2.66666H2.6665V10.6667H4.6665V14L7.99984 10.6667H13.3332V2.66666Z" fill="#333333"/>
                        <path d="M5.33317 5.33332H10.6665M5.33317 7.99999H8.6665M2.6665 2.66666H13.3332V10.6667H7.99984L4.6665 14V10.6667H2.6665V2.66666Z" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
                <div className={style.headerdiv}>
