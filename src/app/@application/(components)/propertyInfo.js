...
export default function PropertyInfo({h1Text, buttonText, buttonFunc, arrProperties, isEdit, extraButtonText, extraButtonFunc, showSvg}) {
    return(
        ...
        {showSvg && <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            extraButtonText && 
            <button className={style.label} onClick={()=> {
                extraButtonFunc()
