...
export default function ExpenseTitle({title, text,showDivider, underTitle,dividerPos,buttonText1, showCount, buttonText2, svg1, svg2, showDropDown}){
    ...
    return(
        <div className={style.header}>
            ...
            {
               (buttonText1 || buttonText2) && <ButtonDivider showDivider={showDivider} dividerPos={dividerPos} svg1={svg1 || false} svg2={svg2 || false} buttonText1={buttonText1} buttonText2={buttonText2}/>
            }
            {
                text && <p>{text}</p>
            }
